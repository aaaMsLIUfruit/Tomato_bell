...
void Sign_in::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->userLoggedIn((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        {
            using _t = void (Sign_in::*)(int );
            if (_t _q_method = &Sign_in::userLoggedIn; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Sign_in::userLoggedIn(int _t1)
{
