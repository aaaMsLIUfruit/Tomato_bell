...
QT_MOC_LITERAL(1, 8, 12), // "returnToMain"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 24), // "on_return_button_clicked"
QT_MOC_LITERAL(4, 47, 14) // "on_yes_clicked"

    },
    "Sign_in\0returnToMain\0\0on_return_button_clicked\0"
    "on_yes_clicked"
};
...
void Sign_in::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Sign_in::returnToMain)) {
                *result = 0;
                return;
            }
        }
