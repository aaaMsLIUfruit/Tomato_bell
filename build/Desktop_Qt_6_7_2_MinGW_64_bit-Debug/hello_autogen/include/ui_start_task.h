...
public:
    ...
    void setupUi(QWidget *start_task)
    {
        ...
        start_task->setFont(font);
        label = new QLabel(start_task);
        label->setObjectName("label");
        label->setGeometry(QRect(260, 90, 311, 51));
        label_2 = new QLabel(start_task);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(240, 160, 141, 41));
        label_3 = new QLabel(start_task);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(240, 220, 131, 31));
        spinBox = new QSpinBox(start_task);
        spinBox->setObjectName("spinBox");
        spinBox->setGeometry(QRect(380, 220, 61, 31));
        spinBox->setMaximum(10);
        start = new QPushButton(start_task);
        start->setObjectName("start");
        start->setGeometry(QRect(450, 340, 91, 31));
        pushButton_2 = new QPushButton(start_task);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(280, 340, 91, 31));
        comboBox = new QComboBox(start_task);
        comboBox->setObjectName("comboBox");
        comboBox->setGeometry(QRect(380, 170, 161, 31));
        pushButton = new QPushButton(start_task);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(420, 280, 181, 31));
        lineEdit = new QLineEdit(start_task);
        lineEdit->setObjectName("lineEdit");
        lineEdit->setGeometry(QRect(240, 280, 161, 31));
    ...
    void retranslateUi(QWidget *start_task)
    {
        ...
        label->setText(QCoreApplication::translate("start_task", "\345\222\214\345\260\217\345\205\253\344\270\200\350\265\267\345\274\200\345\247\213\344\270\200\344\270\252\347\225\252\350\214\204\351\222\237\344\273\273\345\212\241!", nullptr));
