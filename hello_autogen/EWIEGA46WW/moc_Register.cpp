...
QT_MOC_LITERAL(3, 23, 24), // "on_return_button_clicked"
QT_MOC_LITERAL(4, 48, 14) // "on_yes_clicked"

    },
    "Register\0returnToMain\0\0on_return_button_clicked\0"
    "on_yes_clicked"
};
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Register::returnToMain)) {
                *result = 0;
                return;
            }
        }
