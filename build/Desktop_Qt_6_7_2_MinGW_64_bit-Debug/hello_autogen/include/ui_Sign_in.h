...
public:
    ...
    void setupUi(QWidget *Sign_in)
    {
        ...
        Password->setGeometry(QRect(270, 420, 300, 35));
        Password->setEchoMode(QLineEdit::Normal);
        Account = new QLineEdit(Sign_in);
        Account->setObjectName("Account");
        Account->setGeometry(QRect(270, 340, 300, 35));
        Account->setEchoMode(QLineEdit::Normal);
        label = new QLabel(Sign_in);
        label->setObjectName("label");
        label->setGeometry(QRect(200, 340, 60, 30));
        QFont font;
        ...
        label_2->setGeometry(QRect(200, 420, 60, 30));
        label_2->setFont(font);
        yes = new QPushButton(Sign_in);
        yes->setObjectName("yes");
        yes->setGeometry(QRect(310, 510, 120, 30));
        yes->setFont(font);
